...
gearbox, gearbox_name = bom.get_part(
    "./parts/stepperonline/nema17-gearbox-planetary-100"
)
result.add(
    gearbox,
    name=gearbox_name,
...
if __name__ == "__main__":
    ...
    cq.exporters.export(
        shape,
        "generated_files/robots/don1/turn_table.svg",
        opt=exportSvgOpts,
    )

    print("Generating PNG...")
    cairosvg.svg2png(
        url="generated_files/robots/don1/turn_table.svg",
        write_to="generated_files/robots/don1/turn_table.png",
